...
describe('buildPiTaskPrompt', () => {
  ...
  test('网页与 PPT 任务仅恢复对应的实际可用工作流规则', () => {
    const prompt = buildPiTaskPrompt({
      ...
      toolNames: ['BrowserObserve', 'inspect_deck_sources', 'create_deck_project', 'confirm_deck_brief', 'compile_deck_project', 'plan_ppt_visuals', 'audit_ppt_delivery', 'open_file_preview'],
