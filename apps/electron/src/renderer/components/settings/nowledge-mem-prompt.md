...
### 第 2 步：下载并配置 MCP 插件
请帮我：
1. 从 Nowledge Mem 获取 Profer MCP 插件配置
...
2. Hooks 配置已生效
3. 提示我**完全退出并重启 Profer**，使 MCP 与 Hooks 生效
