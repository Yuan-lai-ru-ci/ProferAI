...
export function AgentImageGenerationCardView({ card }: { card: AgentImageGenerationCard }): React.ReactElement | null {
  ...
  return <div className="mx-1 my-2 flex max-w-[42rem] items-center gap-2 rounded-lg border border-primary/25 bg-primary/[0.04] px-3 py-2 text-sm text-muted-foreground">
