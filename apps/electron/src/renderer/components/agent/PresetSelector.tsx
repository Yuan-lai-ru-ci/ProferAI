...
export function PresetSelector({ sessionId, persistedPresetId, workspaceSlug, tabletMode = false }: PresetSelectorProps): React.ReactElement | null {
    ...
    >
      <div className="flex flex-col gap-0.5">
        <div className="flex items-center justify-between px-2 py-1">
          ...
          <label className="flex cursor-pointer items-center gap-1.5 select-none text-[11px] text-foreground/55">
            <span>极简</span>
        ...
        {presets.map((preset) => (
          <AgentComposerToolMenuItem
            key={preset.id}
            selected={preset.id === effectiveId}
