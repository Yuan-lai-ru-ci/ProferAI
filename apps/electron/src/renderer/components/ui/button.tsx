...
const buttonVariants = cva(
  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[transform,background-color,box-shadow,border-color,color] duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus/40 focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 active:scale-[0.97] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 select-none",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-surface-border/60 bg-control/60 backdrop-blur-[2px] text-foreground shadow-xs hover:bg-control-hover/70 hover:border-surface-border-strong hover:text-accent-foreground hover:shadow-sm",
        secondary:
          "bg-control text-secondary-foreground shadow-xs hover:bg-control-hover hover:shadow-sm",
