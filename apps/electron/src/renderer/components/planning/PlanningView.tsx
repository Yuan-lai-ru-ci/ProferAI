...
function TodoWorkspace({ standalone = false, teamWorkspaceId }: { standalone?: boolean; teamWorkspaceId?: string } = {}): React.ReactElement {
  ...
  return (
    <section className="relative h-full min-h-[580px] overflow-hidden rounded-2xl border border-border/50 bg-card shadow-[0_10px_30px_rgb(0_0_0_/_0.035)]">
      <div className="grid h-full min-h-0 w-full grid-cols-[minmax(10.5rem,13.5rem)_minmax(0,1fr)] overflow-hidden">
        <aside className="flex min-h-0 flex-col overflow-y-auto border-r border-border/45 bg-muted/25 p-3 scrollbar-thin">
